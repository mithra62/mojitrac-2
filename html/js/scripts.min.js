...
(function($){$.facebox=function(data,klass){$.facebox.loading()
	...
	$.extend($.facebox,{settings:{opacity:0,overlay:true,loadingImage:'/images/loading.gif',closeImage:'http://static.mojitrac.com/images/closelabel.gif',imageTypes:['png','jpg','jpeg','gif'],faceboxHtml:'\
