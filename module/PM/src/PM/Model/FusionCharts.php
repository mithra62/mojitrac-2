...
use Application\Model\AbstractModel;
 ...
 /**
 * PM - Fusion Charts Model
 *
 * @author		Infosoft Global Pvt. Ltd.
 * @filesource 	./module/PM/src/PM/Model/FusionCharts.php
 */
class FusionCharts extends AbstractModel
{
	...
	public $SWFPath;                 # relative path of FusionCharts SWF files
	public $width;                   # FusionCharts width
	public $height;                  # FusionCharts height
	...
	public $categoriesParam;           # Categories Parameter Setting 
	public $categoryNames = array();   # Category array for storing Category set
	public $categoryNamesCounter;      # Category array counter
	
	public $dataset = array();         # dataset array
	public $datasetParam = array();    # dataset parameter setting array
	public $datasetCounter;            # dataset array counter
	public $setCounter;                # set array counter 


    # trendLines array
    public $trendLines = array();      # trendLines array
	public $tLineCounter;              # trendLines array counter

    #chart messages
	public $chartMSG;

	public $chartSWF = array();		# Charts SWF array
	public $arr_FCColors = array(); 	# Color Set to be applied to dataplots
	public $UserColorON;               # User define color define true or false
    public $userColorCounter;
	
	// Cache Control
	public $noCache;

    public $DataBaseType;             # DataBase Type
	
	public $encodeChars;               # XML for dataXML or dataURL
	
#############============ For Gantt Chart  ============================
    # Gantt categories
	public $GT_categories = array();
	public $GT_categories_Counter;
	public $GT_categoriesParam = array();
	 
	public $GT_subcategories_Counter; 
	
	# Gantt processes
	public $GT_processes = array();
	public $GT_processes_Counter;
	public $GT_processes_Param;
	
	# Gantt Tasks
	public $GT_Tasks = array();
	public $GT_Tasks_Counter;
	public $GT_Tasks_Param;
	
	# Gantt Connectors
	public $GT_Connectors = array();
	public $GT_Connectors_Counter;
	public $GT_Connectors_Param;

	# Gantt Milestones
	public $GT_Milestones = array();
	public $GT_Milestones_Counter;
	public $GT_Milestones_Param;
	
	# Gantt datatable
	public $GT_datatable = array();
	public $GT_datatable_Counter;
	public $GT_datatableParam;
	public $GT_dataColumnParam = array();
	 
	public $GT_subdatatable_Counter; 
	
	#------- For Futute Use (start)----------------	
	# Gantt legend
	public $GT_legend = array();
	public $GT_legend_Counter;
	public $GT_legend_Param;
	#------- For Futute Use (end)----------------
...
#############============ For Future Use (start)============================
	...
	public $MSSDataset = array();       # dataset array for MSStackedColumn2D
	public $MSSDatasetParams = array();  # MSSDataset parameter setting
	
	public $MSSDatasetCounter;          # MSSDataset array counter
    public $MSSSubDatasetCounter;       # ms sub dataset array counter
	public $MSSSetCounter;              # msset array counter
	
	# lineset 
	public $lineSet = array();         # lineSet array
	public $lineSetParam = array();    # lineSet Parameter setting array
	  
	public $lineCounter;               # line array counter 
	public $lineSetCounter;            # lineset array counter
	public $lineIDCounter;             # lineID counter;
	
	# vtrendLines array
    public $vtrendLines = array();     # vtrendLines array
	public $vtLineCounter;             # vtrendLines array counter

    # style array
    public $styles = array();           # styles array
    public $styleDefCounter;                # define counter
	public $styleAppCounter;                # apply counter
...
#############============ For Future Use (end)============================
	 ...
	 public function setup($chartType="column2d",$width="400",$height="300",$chartID="",$isTransparent='yes'){
