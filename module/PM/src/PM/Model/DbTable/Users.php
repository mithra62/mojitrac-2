...
* @version		1.0
* @filesource 	./moji/application/modules/pm/modeles/DbTable/Users.php
*/

/**
* PM - Users Database Model
*
* Returns the Users Database Model
*
* @package 		mithra62:Mojitrac
* @author		Eric Lamb
* @filesource 	./moji/application/modules/pm/modeles/DbTable/Users.php
*/
class PM_Model_DbTable_Users extends Model_DbTable_Abstract
{
   /**
     * Table name
     * @var string
