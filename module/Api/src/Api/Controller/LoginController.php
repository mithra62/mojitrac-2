	...
	*/
    ...
    public function indexAction()
    {
    	...
    	{	
			...
			$login->setAuthAdapter($this->getServiceLocator()->get('Zend\Db\Adapter\Adapter'));
			...
			$result = $login->procLogin($data['email'], $data['password'], $this->getServiceLocator()->get('AuthService'));
			switch ($result)
			{
