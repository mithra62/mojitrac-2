...
(function($){ 
	...
	$.fn.samePassword = 'Email and Password identical.';
	$.fn.resultStyle = "";
		 ...
		 var defaults = {
		 	...
		 	return this.each(function() { 
		 		...
		 		$.fn.teststrength = function(password,username,option){
		 			    ...
		 			    //password == user name
		 			    if (option.enableUcheck == 1 && password.toLowerCase()==username.toLowerCase()){this.resultStyle = option.badPass;return $(this).samePassword;}
